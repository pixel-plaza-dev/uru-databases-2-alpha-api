...
export const USER_CHANGED_PASSWORD =
  'User changed password. Please login again' as const;
...
export const getChangedUsernameMessage = (username: string) =>
  `User changed username to ${username}` as const;
